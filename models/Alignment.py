    ...
    def __init__(self, opts, net=None):
        ...
        if self.opts.kp_loss:
            ...
            if self.opts.kp_type =='2D':
                self.kp_extractor = face_alignment.FaceAlignment(face_alignment.LandmarksType._2D, flip_input=False)
            else:
                self.kp_extractor = face_alignment.FaceAlignment(face_alignment.LandmarksType._3D, flip_input=False)
